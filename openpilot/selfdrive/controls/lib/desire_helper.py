...
class DesireHelper:
  ...
  def update(self, carstate, lateral_active, lane_change_prob, auto_start=False):
    # auto_start: fork nudgeless lane change (auto_lane_change.py) stands in for the steering nudge
    v_ego = carstate.vEgo
